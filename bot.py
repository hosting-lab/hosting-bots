...
def updates_handler(message):
    bot.send_message(message.chat.id, "📢 Join our channel: t.me/bhaicodex")

@bot.message_handler(func=lambda m: m.text == "📞 Contact Owner")
def contact_handler(message):
    bot.send_message(message.chat.id, "📞 Contact: @mdjubayer_ofcl")
